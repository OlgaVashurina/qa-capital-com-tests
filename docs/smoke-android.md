...
### 📋 Block: Account Management & Home Navigation
...
| №    | Title                                                          | ER (Expected Result)                                       | AR (Actual Result) | Status   |
|------|----------------------------------------------------------------|------------------------------------------------------------|--------------------|----------|
| SC49 | Switching between "Trades", "Orders", "Alerts" tabs            | Tabs switch correctly without issues                       |                    | Pending  |
| SC50 | "Top Risers" list opens from "Trades" tab                      | "Top Risers" list opens correctly from "Trades" tab        |                    | Pending  |
| SC51 | "Top Risers" list opens from "Orders" tab                      | "Top Risers" list opens correctly from "Orders" tab        |                    | Pending  |
| SC52 | "Top Risers" list opens from "Alerts" tab                      | "Top Risers" list opens correctly from "Alerts" tab        |                    | Pending  |
| SC53 | "Top Fallers" list opens from "Trades" tab                     | "Top Fallers" list opens correctly from "Trades" tab       |                    | Pending  |
| SC54 | "Top Fallers" list opens from "Orders" tab                     | "Top Fallers" list opens correctly from "Orders" tab       |                    | Pending  |
| SC55 | "Top Fallers" list opens from "Alerts" tab                     | "Top Fallers" list opens correctly from "Alerts" tab       |                    | Pending  |
| SC56 | "Most Traded" list opens from "Trades" tab                     | "Most Traded" list opens correctly from "Trades" tab       |                    | Pending  |
| SC57 | "Most Traded" list opens from "Orders" tab                     | "Most Traded" list opens correctly from "Orders" tab       |                    | Pending  |
| SC58 | "Most Traded" list opens from "Alerts" tab                     | "Most Traded" list opens correctly from "Alerts" tab       |                    | Pending  |
| SC59 | "Most Volatile" list opens from "Trades" tab                   | "Most Volatile" list opens correctly from "Trades" tab     |                    | Pending  |
| SC60 | "Most Volatile" list opens from "Orders" tab                   | "Most Volatile" list opens correctly from "Orders" tab     |                    | Pending  |
| SC61 | "Most Volatile" list opens from "Alerts" tab                   | "Most Volatile" list opens correctly from "Alerts" tab     |                    | Pending  |
| SC62 | "More" menu expands from "Trades" tab                          | "More" menu expands correctly from "Trades" tab            |                    | Pending  |
| SC63 | "More" menu expands from "Orders" tab                          | "More" menu expands correctly from "Orders" tab            |                    | Pending  |
| SC64 | "More" menu expands from "Alerts" tab                          | "More" menu expands correctly from "Alerts" tab            |                    | Pending  |
| SC65 | "Transportation Companies" list opens from "Trades" tab        | "Transportation Companies" list opens correctly from "Trade|                    | Pending  |
| SC66 | "Transportation Companies" list opens from "Orders" tab        | "Transportation Companies" list opens correctly from "Order|                    | Pending  |
| SC67 | "Transportation Companies" list opens from "Alerts" tab        | "Transportation Companies" list opens from "Alerts" tab    |                    | Pending  |
| SC68 | "Cybersecurity Stocks" list opens from "Trades" tab            | "Cybersecurity Stocks" list opens from "Trades" tab        |                    | Pending  |
| SC69 | "Cybersecurity Stocks" list opens from "Orders" tab            | "Cybersecurity Stocks" list opens from "Orders" tab        |                    | Pending  |
| SC70 | "Cybersecurity Stocks" list opens from "Alerts" tab            | "Cybersecurity Stocks" list opens from "Alerts" tab        |                    | Pending  |
| SC71 | "Biggest Energy Companies" list opens from "Trades" tab        | "Biggest Energy Companies" list opens from "Trades" tab    |                    | Pending  |
| SC72 | "Biggest Energy Companies" list opens from "Orders" tab        | "Biggest Energy Companies" list opens from "Orders" tab    |                    | Pending  |
| SC73 | "Biggest Energy Companies" list opens from "Alerts" tab        | "Biggest Energy Companies" list opens from "Alerts" tab    |                    | Pending  |
| SC74 | "Largest Pharmaceuticals" list opens from "Trades" tab         | "Largest Pharmaceuticals" list opens from "Trades" tab     |                    | Pending  |
| SC75 | "Largest Pharmaceuticals" list opens from "Orders" tab         | "Largest Pharmaceuticals" list opens from "Orders" tab     |                    | Pending  |
| SC76 | "Largest Pharmaceuticals" list opens from "Alerts" tab         | "Largest Pharmaceuticals" list opens from "Alerts" tab     |                    | Pending  |
| SC77 | "Top Tech Companies" list opens from "Trades" tab              | "Top Tech Companies" list opens from "Trades" tab          |                    | Pending  |
| SC78 | "Top Tech Companies" list opens from "Orders" tab              | "Top Tech Companies" list opens from "Orders" tab          |                    | Pending  |
| SC79 | "Top Tech Companies" list opens from "Alerts" tab              | "Top Tech Companies" list opens from "Alerts" tab          |                    | Pending  |
| SC80 | Instrument state is displayed (Active/Sleep/Locked)            | Appropriate instrument label is shown (Active/Sleep/Locked)|                    | Pending  |
